...
export const Route = createFileRoute("/vectofix/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — VectoFix" },
      {
        name: "description",
        content:
          "How VectoFix handles your data. VectoFix processes your files 100% locally — your images never leave your computer.",
      },
      { property: "og:title", content: "Privacy Policy — VectoFix" },
      { property: "og:url", content: "https://www.vectorpop.fr/vectofix/privacy" },
    ],
    links: [
      { rel: "canonical", href: "https://www.vectorpop.fr/vectofix/privacy" },
    ],
  }),
  component: Privacy,
});
...
const CONTACT = "contact@lafabriknumerique.fr";
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix est édité par William GEORGE, entrepreneur individuel exerçant sous le nom commercial « La Fabrik Numérique » (SIRET : 518 251 897 00048 — adresse : 18 rue de l'Oiseau Blanc, 42155 Saint-Léger-sur-Roanne), ci-après « nous » ou « VectoFix ».",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix traite vos images et vos fichiers SVG directement sur votre ordinateur. Vos fichiers ne sont jamais envoyés vers un serveur, un cloud ou un tiers : ils ne quittent pas votre machine. La mesure de fidélité et le pinceau magique de correction s'exécutent en local, sur votre processeur.",
          },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "L'achat de la licence VectoFix et la gestion des licences sont assurés par notre prestataire de paiement Lemon Squeezy, qui agit en tant que revendeur officiel (« merchant of record »). Lors d'un achat, Lemon Squeezy collecte les données nécessaires à la transaction :",
          },
          {
            type: "ul",
            items: [
          ...
          {
            type: "p",
            text: "Si vous achetez VectoFix via le Microsoft Store, la transaction et les données associées sont gérées par Microsoft, conformément à sa propre politique de confidentialité.",
          },
        ],
      },
      {
        h: "4. La page vectorpop.fr/vectofix",
        blocks: [
          {
            type: "p",
            text: "La page est une vitrine de présentation. Nous utilisons Vercel Web Analytics, un outil de mesure d'audience respectueux de la vie privée et sans cookie, qui comptabilise de manière agrégée et anonyme la fréquentation et les téléchargements (pages vues, pays, type d'appareil) sans déposer de cookie ni collecter de donnée permettant de vous identifier. Le site n'utilise aucun cookie publicitaire ni traceur tiers.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix n'est pas destiné aux personnes de moins de 15 ans et nous ne collectons pas sciemment de données les concernant.",
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix is published by William GEORGE, a sole trader operating under the commercial name “La Fabrik Numérique” (business registration (SIRET): 518 251 897 00048 — address: 18 rue de l'Oiseau Blanc, 42155 Saint-Léger-sur-Roanne, France), referred to below as “we” or “VectoFix”.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix processes your images and SVG files directly on your computer. Your files are never sent to a server, the cloud, or any third party: they never leave your machine. The fidelity measurement and the magic-brush correction tool run locally, on your own processor.",
          },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix license purchases and license management are handled by our payment provider Lemon Squeezy, acting as merchant of record. When you make a purchase, Lemon Squeezy collects the data required for the transaction:",
          },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "VectoFix is not intended for individuals under the age of 15, and we do not knowingly collect data about them.",
          },
        ],
      },
      {
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border/50 bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-4 px-6 py-4">
          <Link to="/vectofix" className="flex items-center gap-2">
