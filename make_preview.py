...
OUT = (
    r"C:\Users\William\Documents\Entreprenariat\VectorPop\icon_preview_sizes_plume.png"
)
...
rows = [
    ("Fond clair", (245, 245, 247, 255), (40, 40, 40, 255)),
...
draw.text(
    (pad, 20),
    "VectorPop (plume) — test de lisibilite multi-tailles",
    font=font(28),
    fill=(20, 20, 20, 255),
)
...
for ri, (rname, bg, fg) in enumerate(rows):
    ...
    for i, s in enumerate(sizes):
        ...
        draw.text(
            (x + cw // 2 - 14, base_y + 256 + 6), f"{s}px", font=font(18), fill=fg
        )
        x += cw + gap
