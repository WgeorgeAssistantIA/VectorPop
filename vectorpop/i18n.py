...
STRINGS = {
    "fr": {
        ...
        "demo_logo_tooltip": "Logo & badge — aplats nets, fond supprimé",
        "demo_mascot_title": "Mascotte",
        "demo_mascot_tooltip": "Mascotte & sticker — richesse des calques et couleurs vives",
        "demo_sketch_title": "Croquis",
        "demo_sketch_tooltip": "Croquis & signature — courbes pures en noir et blanc",
        "demo_icon_title": "Icône",
        ...
        "btn_batch": " Traitement par lot…",
        "btn_batch_tooltip": "Vectorise plusieurs images ou des dossiers entiers avec les réglages actuels (vous pouvez aussi les glisser dans la fenêtre).",
        ...
        "batch_add_files": "Ajouter des images…",
        "batch_add_folder": "Ajouter un dossier…",
        "batch_recursive": "Inclure les sous-dossiers",
        "batch_clear": "Vider la liste",
        "batch_drop_hint": "Glissez ici des images ou des dossiers (PNG, JPEG, BMP, WebP).",
        "batch_formats": "Formats :",
        "batch_png_size": "PNG, côté long (px) :",
        "batch_autotune": "Optimiser chaque image (plus long)",
        "batch_autotune_tooltip": "Cherche automatiquement les meilleurs réglages pour CHAQUE image (≈ 10 fois plus long qu'une vectorisation simple).",
        "batch_background": "Fond :",
        "bg_transparent": "Transparent",
        "bg_white": "Blanc",
        "batch_output": "Dossier de sortie :",
        "batch_choose": "Choisir…",
        "batch_suffix": "Suffixe des fichiers :",
        "batch_subdir": "Un sous-dossier par format",
        "batch_start": "Lancer ({n} image(s))",
        "batch_close": "Fermer",
        "batch_retry": "Relancer les échecs ({n})",
        "batch_open_output": "Ouvrir le dossier de sortie",
        "batch_status_pending": "en attente",
        "batch_status_running": "en cours…",
        "batch_status_ok": "OK",
        "batch_status_warning": "OK (dégradés/affinage ignorés)",
        "batch_status_error": "erreur : {msg}",
        "batch_summary": "{ok} réussie(s), {warn} avec avertissement, {err} en erreur.",
        "batch_summary_cancelled": "Arrêté : {ok} réussie(s), {err} en erreur.",
        "batch_no_format": "Cochez au moins un format.",
        "chk_white_bg": "Fond blanc à l'export",
        ...
        "pro_dialog_badge": "ACCÈS À VIE — SANS ABONNEMENT",
        "pro_dialog_close": "Fermer",
        "pro_dialog_feat_unlimited": "Exports SVG illimités à vie (sans plafond)",
        "pro_dialog_feat_hd": "Export PDF vectoriel et PNG Ultra-HD",
        "pro_dialog_feat_batch": "Traitement par lot (dossier entier)",
        "pro_dialog_feat_ai": "Détourage et finition IA illimités, en local",
        "pro_dialog_feat_autotune": "Réglage automatique (Optimiser)",
        "pro_dialog_feat_delete": "Suppression d'aplats au clic",
    ...
    "en": {
        ...
        "demo_logo_title": "Logo",
        "demo_logo_tooltip": "Logo & badge — clean flats, background removed",
        "demo_mascot_title": "Mascot",
        "demo_mascot_tooltip": "Mascot & sticker — rich color layers & bright shades",
        "demo_sketch_title": "Sketch",
        "demo_sketch_tooltip": "Sketch & signature — pure black & white curves",
        "demo_icon_title": "Icon",
        ...
        "btn_batch_tooltip": "Vectorizes several images or whole folders with the current settings (you can also drop them onto the window).",
        "btn_compare": " Compare",
        ...
        "batch_add_folder": "Add a folder…",
        "batch_recursive": "Include subfolders",
        "batch_clear": "Clear list",
        "batch_drop_hint": "Drop images or folders here (PNG, JPEG, BMP, WebP).",
        "batch_formats": "Formats:",
        "batch_png_size": "PNG, long side (px):",
        "batch_autotune": "Optimize each image (slower)",
        "batch_autotune_tooltip": "Automatically searches the best settings for EACH image (about 10 times slower than a plain vectorization).",
        "batch_background": "Background:",
        "bg_transparent": "Transparent",
        "bg_white": "White",
        "batch_output": "Output folder:",
        "batch_choose": "Choose…",
        "batch_suffix": "File suffix:",
        "batch_subdir": "One subfolder per format",
        "batch_start": "Start ({n} image(s))",
        "batch_close": "Close",
        "batch_retry": "Retry failures ({n})",
        "batch_open_output": "Open output folder",
        "batch_status_pending": "pending",
        "batch_status_running": "running…",
        "batch_status_ok": "OK",
        "batch_status_warning": "OK (gradients/refine skipped)",
        "batch_status_error": "error: {msg}",
        "batch_summary": "{ok} done, {warn} with warnings, {err} failed.",
        "batch_summary_cancelled": "Stopped: {ok} done, {err} failed.",
        "batch_no_format": "Tick at least one format.",
        "chk_white_bg": "White background on export",
        ...
        "pro_dialog_badge": "LIFETIME ACCESS — NO SUBSCRIPTION",
        "pro_dialog_close": "Close",
        "pro_dialog_feat_unlimited": "Lifetime unlimited SVG exports (no limit)",
        "pro_dialog_feat_hd": "Vector PDF and Ultra-HD PNG export",
        "pro_dialog_feat_batch": "Batch processing (whole folder)",
        "pro_dialog_feat_ai": "Unlimited AI background removal and finishing, on-device",
        "pro_dialog_feat_autotune": "Auto-tune",
        "pro_dialog_feat_delete": "Click-to-remove shapes",
