...
[Setup]
AppId={{CC85136F-8B12-468A-9F51-C09475618662}
AppName={#MyAppName}
...
OutputBaseFilename=VectorPop-Setup-{#MyAppVersion}
...
[Files]
Source: "dist\VectorPop\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
